        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              ...
              <button className="bg-cyan-500 text-white px-5 py-2.5 rounded-xl font-black text-sm">
                Open Data
              </button>

              <button className="bg-white/10 border border-white/10 text-white px-5 py-2.5 rounded-xl font-black text-sm">
                Rapports
              </button>
          ...
          <div>
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-[24px] p-5">
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-xl">
                  🌍
                </div>
