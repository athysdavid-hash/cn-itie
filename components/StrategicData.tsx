export default function StrategicData() {
  ...
  return (
    <section className="relative w-full bg-[#031b34] py-12 overflow-hidden">
      ...
      {/* GLOW subtil */}
      <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-cyan-500/10 blur-3xl rounded-full" />
      <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-blue-500/10 blur-3xl rounded-full" />
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-300 mt-3 max-w-2xl text-sm leading-relaxed">
            ...
            basée sur les dernières données disponibles.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {data.map((item, index) => (
            <div
              key={index}
              className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-md hover:bg-white/10 transition-all duration-300"
            >
