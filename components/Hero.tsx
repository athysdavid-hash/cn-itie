      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* BADGE */}
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 px-4 py-2 rounded-full mb-6">
            ...
            {/* DESCRIPTION */}
            <p className="text-slate-200 text-lg leading-relaxed mt-6 max-w-xl">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              ...
              <button className="bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-3 rounded-2xl font-black shadow-xl transition-all duration-300">

                Explorer les données

              </button>

              <button className="bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/20 text-white px-6 py-3 rounded-2xl font-black transition-all duration-300">
          ...
          <div className="flex justify-end">
            ...
            <div className="w-full max-w-lg bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[32px] p-8 shadow-2xl">
              ...
              <p className="text-slate-200 mt-4 leading-relaxed text-sm">
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-4 gap-4 bg-white/10 backdrop-blur-2xl border border-white/10 rounded-[28px] p-6">
